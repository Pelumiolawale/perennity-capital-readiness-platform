...
export const SNAPSHOT_PHRASES = {
  ...
  sfdr_v1_e_s_characteristics_promotion: {
    aligned: {
      template:
        "The project demonstrates the promotion of a named environmental or social characteristic ({named_characteristic}), with a documented mechanism of advancement and governance arrangements to maintain it over the product life. SFDR Article 8(1) is satisfied.",
      defaults: { named_characteristic: "a named E/S characteristic" },
    },
    partially_aligned: {
      template:
        "The project promotes a named environmental or social characteristic, with {gap_summary} remaining before full Article 8(1) disclosure standards are met.",
      defaults: {
        gap_summary:
    ...
    not_aligned: {
      template:
        "The project does not demonstrate the promotion of an identifiable environmental or social characteristic to the standard required by SFDR Article 8(1); {primary_gap}.",
      defaults: {
        primary_gap:
    ...
    insufficient_evidence: {
      template:
        "The project's E/S characteristics framing cannot be verified to Article 8(1) standards from inputs supplied; {missing_inputs}.",
      defaults: {
        missing_inputs:
...
export function snapshotPhraseFor(verdict) {
  ...
  return interpolatePhrase(band.template, band.defaults, verdict.inputs_used);
}
