      ...
      <div style={S.modal}>
        <div style={S.header}>
          <div>
            ...
            <div style={{ fontSize: 12, color: COLORS.textMuted, marginTop: 2 }}>Perennity Bridge Capital Readiness Platform</div>
          </div>
        ...
        <div style={S.body} ref={scrollRef}>
          ...
          <p style={S.p}><span style={S.bold}>Perennity Bridge Ltd</span> (a company registered in England and Wales) ("Perennity Bridge", "we", "our", or the "Company"); and</p>
          <p style={S.p}><span style={S.bold}>You, the User</span> ("User", "you", or "your"), being any individual or entity that accesses, registers for, or uses the Perennity Bridge Capital Readiness Platform (the "Platform").</p>
          ...
          <p style={S.p}><span style={S.bold}>Platform:</span> the Perennity Bridge Capital Readiness Platform, including all associated software, tools, scoring engines, assessment outputs, reports, interfaces, APIs, and documentation provided or made available by Perennity Bridge.</p>
          ...
          <p style={S.p}><span style={S.bold}>Purpose:</span> the User's use of the Platform to assess the capital readiness and sustainability alignment of data centre projects, and to explore a potential advisory or commercial relationship with Perennity Bridge.</p>
          ...
          <p style={S.p}>3.1 Subject to your compliance with this Agreement, Perennity Bridge grants you a limited, non-exclusive, non-transferable, revocable licence to access and use the Platform solely for the Purpose.</p>
          <p style={S.p}>3.2 Perennity Bridge reserves the right to modify, suspend, or discontinue any aspect of the Platform at any time, with or without notice. We shall not be liable to you or any third party for any modification, suspension, or discontinuation of the Platform.</p>
          ...
          <p style={S.list}>(e) the Perennity Bridge scoring methodology, algorithms, weighting models, threshold configurations, and rules engine logic; and</p>
          ...
          <p style={S.p}>5.3 All intellectual property rights in and to the Platform, including the scoring engine, algorithms, methodologies, user interface, software, documentation, and all Platform Outputs, shall remain vested exclusively in Perennity Bridge or its licensors.</p>
          <p style={S.p}>5.4 All intellectual property rights in User Data shall remain vested in the User. The User grants Perennity Bridge a limited, non-exclusive licence to process User Data solely for operating the Platform.</p>
          ...
          <p style={S.list}>(f) the User shall indemnify and hold harmless Perennity Bridge from any claims arising from breach of this clause 6.</p>
          <p style={S.p}>6.2 Perennity Bridge shall have no liability whatsoever for any loss arising from the User's submission of personal data, production data, or any data in breach of clause 6.1.</p>
          <p style={S.p}>6.3 Perennity Bridge may use anonymised and aggregated data derived from User Data for improving the Platform, developing benchmarks, and conducting research, provided such data cannot reasonably identify the User or any individual.</p>
          ...
          <p style={S.p}><span style={S.bold}>7.3 No Guarantees.</span> Perennity Bridge does not warrant that: (a) the Platform will be uninterrupted, error-free, or secure; (b) Platform Outputs will be accurate, complete, or fit for any particular purpose; (c) the scoring methodology reflects the most current regulatory framework version; (d) defects will be corrected; or (e) the Platform will meet specific requirements.</p>
          <p style={S.p}><span style={S.bold}>7.4 Exclusion of Liability.</span> To the maximum extent permitted by law, Perennity Bridge shall not be liable for: (a) any indirect, incidental, special, consequential, or exemplary damages including loss of profits, revenue, business, data, or goodwill; (b) loss arising from reliance on Platform Outputs; (c) loss arising from User's breach of clause 6; (d) loss from unauthorised access to User's data; or (e) loss from Platform unavailability or discontinuation.</p>
          <p style={S.p}><span style={S.bold}>7.5 Liability Cap.</span> Perennity Bridge's total aggregate liability shall not exceed the total fees paid by the User in the twelve (12) months preceding the claim, or one hundred pounds sterling (£100), whichever is greater.</p>
          ...
          <p style={S.p}>The User shall indemnify, defend, and hold harmless Perennity Bridge from all claims, losses, damages, liabilities, costs, and expenses arising from: (a) any breach of this Agreement by the User; (b) the User's use of the Platform; (c) submission of data in breach of clause 6; (d) any third-party claim arising from the User's acts or omissions; and (e) any misrepresentation of Platform Outputs.</p>
          ...
          <p style={S.p}>14.1 This Agreement takes effect upon acceptance (by account creation, clicking "I Accept", or continued use) and continues while the User maintains an account. 14.2 Perennity Bridge may terminate immediately for material breach. 14.3 The User may terminate by closing their account. 14.4 Confidentiality obligations survive for three (3) years after termination. 14.5 Clauses 4, 5, 6, 7, 8, 12, and 13 survive termination.</p>
          ...
          <p style={S.p}><span style={S.bold}>16.3 Variation.</span> Perennity Bridge may modify this Agreement by posting revised terms. Continued use constitutes acceptance. Material changes will be notified via the Platform or email.</p>
          ...
          <div style={{ marginTop: 32, padding: "16px 20px", borderTop: `1px solid ${COLORS.border}`, textAlign: "center" }}>
            <p style={{ fontSize: 12, color: COLORS.textMuted, fontStyle: "italic" }}>© Perennity Bridge Ltd. All rights reserved.</p>
          </div>
        </div>
...
export function LegacyAppShell() {
  ...
  const [onboardingForm, setOnboardingForm] = useState({ name: "", company: "", role: "developer", email: "", password: "", passwordConfirm: "" });
  ...
  // Rehydrate auth session on boot. If a session exists in
  // localStorage + IndexedDB, skip the landing screen and drop
  // straight into the app — matches the "once signed in, remember
  // them" contract. sessionLoading gates first-paint so the landing
  // screen doesn't flash before we know.
  useEffect(() => {
    (async () => {
      try {
  ...
  function handleLogin(userData) {
    // Used post-signup or post-signin. Pushes user state into the
    // app and fires the Airtable ping (unchanged from before).
    setUser(userData);
    setScreen("app");
    setNavItem("dashboard");
  ...
  async function handleSignup() {
    setOnboardingError("");
    const { name, company, role, email, password, passwordConfirm } = onboardingForm;
    ...
    try {
      const user = await authSignup({ email, name, company, role, password });
      handleLogin(user);
    } catch (e) {
      setOnboardingError(e.message || "Sign-up failed.");
    }
  }
  ...
  // Gate first-paint on session rehydration so returning users don't
  // flash the landing page before getCurrentSession resolves.
  if (sessionLoading) {
    return (
      <>
        <style>{css}</style>
        ...
        <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
          <nav style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "20px 48px", borderBottom: `1px solid ${COLORS.border}` }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <span style={{ fontSize: 14, color: COLORS.textSecondary, cursor: "pointer", fontWeight: 500 }} onClick={() => setScreen("signin")}>Sign in</span>
            ...
            <div style={{ maxWidth: 640, textAlign: "center", animation: "fadeIn 0.6s ease-out" }}>
              ...
              <div style={{ display: "flex", gap: 16, justifyContent: "center" }}>
                ...
                <Button variant="secondary" size="lg" onClick={() => {
                  ...
                  // Ephemeral demo user — NOT persisted to IndexedDB, no
                  // session stored. Navigation out of demo returns to
                  // landing so IP gating stays intact.
                  setUser(prev => prev || { name: "Demo Viewer", company: "Demo", role: "investor", email: "demo@example.com", isDemo: true });
                  setScreen("app");
                  setNavItem("results");
      ...
      <>
        ...
        <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <Card style={{ width: 440, animation: "fadeIn 0.4s ease-out" }}>
            ...
            <FormField label="Password" required help="Minimum 8 characters. Stored securely on this device.">
              <input type="password" value={onboardingForm.password} onChange={e => setOnboardingForm({...onboardingForm, password: e.target.value})} placeholder="Create a password" />
            </FormField>
            <FormField label="Confirm Password" required>
              <input type="password" value={onboardingForm.passwordConfirm} onChange={e => setOnboardingForm({...onboardingForm, passwordConfirm: e.target.value})} placeholder="Re-enter your password" />
            </FormField>
            ...
            <Button
              ...
              disabled={!onboardingForm.name || !onboardingForm.email || !onboardingForm.password || !onboardingForm.passwordConfirm || !tosAccepted}
            >
              Create Account
            </Button>
            {onboardingError && (
              <div style={{ textAlign: "center", marginTop: 8, padding: "8px 10px", borderRadius: 6, background: COLORS.redBg, border: `1px solid ${COLORS.red}33` }}>
                <span style={{ fontSize: 12, color: COLORS.red }}>{onboardingError}</span>
              </div>
            )}
            ...
            <div style={{ textAlign: "center", marginTop: 16 }}>
              ...
              <span style={{ fontSize: 13, color: COLORS.accent, cursor: "pointer", fontWeight: 500 }} onClick={() => { setOnboardingError(""); setScreen("signin"); }}>Sign in</span>
            </div>
          </Card>
        </div>
      </>
      ...
      <>
        ...
        <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <Card style={{ width: 440, animation: "fadeIn 0.4s ease-out" }}>
            ...
            <p style={{ color: COLORS.textSecondary, fontSize: 14, marginBottom: 20 }}>Sign in to continue your capital readiness assessments.</p>

            {/* Demo-auth caveat banner — intentionally visible. */}
            <div style={{ marginBottom: 20, padding: "10px 12px", borderRadius: 8, background: COLORS.amberBg, border: `1px solid ${COLORS.amber}33` }}>
              <div style={{ fontSize: 11, fontWeight: 700, color: COLORS.amber, textTransform: "uppercase", letterSpacing: "0.04em", marginBottom: 2 }}>Demo authentication</div>
              <div style={{ fontSize: 12, color: COLORS.textSecondary, lineHeight: 1.4 }}>Accounts are stored locally on this device. A cloud-synced account system is on the roadmap — don't reuse passwords from other sites.</div>
            </div>

            <FormField label="Email" required>
              <input type="email" value={signinForm.email} onChange={e => setSigninForm({...signinForm, email: e.target.value})} placeholder="you@company.com" onKeyDown={e => { if (e.key === "Enter" && signinForm.email && signinForm.password) handleSignin(); }} />
            </FormField>
            <FormField label="Password" required>
              <input type="password" value={signinForm.password} onChange={e => setSigninForm({...signinForm, password: e.target.value})} placeholder="Your password" onKeyDown={e => { if (e.key === "Enter" && signinForm.email && signinForm.password) handleSignin(); }} />
            </FormField>
            ...
            {signinError && (
              <div style={{ textAlign: "center", marginTop: 10, padding: "8px 10px", borderRadius: 6, background: COLORS.redBg, border: `1px solid ${COLORS.red}33` }}>
                <span style={{ fontSize: 12, color: COLORS.red }}>{signinError}</span>
              </div>
            )}

            <div style={{ textAlign: "center", marginTop: 20 }}>
              <span style={{ fontSize: 13, color: COLORS.textMuted }}>Don't have an account? </span>
              <span style={{ fontSize: 13, color: COLORS.accent, cursor: "pointer", fontWeight: 500 }} onClick={() => { setSigninError(""); setScreen("onboarding"); }}>Create one</span>
            </div>
            <div style={{ textAlign: "center", marginTop: 10 }}>
              <span style={{ fontSize: 12, color: COLORS.textMuted, cursor: "pointer" }} onClick={() => setScreen("landing")}>← Back to landing</span>
            </div>
          </Card>
        </div>
      </>
  ...
  function renderContent() {
    ...
    if (navItem === "results" && currentAssessment) {
      ...
      // Neutered-demo mode — logged-out visitors clicking the
      // landing-page "View Example Assessment" see pillar scores
      // + verdict name, but criteria/recommendations/DNSH/PDF/Excel
      // are all gated behind Create Account CTAs to protect IP.
      const isDemo = !!currentProject?.isDemoSample;
      const BlockCard = ({ title, copy }) => (
        <Card style={{ marginTop: 24, background: COLORS.accentSubtle, borderColor: `${COLORS.accent}33` }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 600, color: COLORS.accent, margin: 0 }}>{title}</h3>
          </div>
          <p style={{ fontSize: 13, color: COLORS.textSecondary, marginBottom: 14, lineHeight: 1.5 }}>{copy}</p>
      ...
      return (
        <div style={{ animation: "fadeIn 0.4s ease-out" }}>
          ...
          {isDemo ? (
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
              <BlockCard title="Top Risks — available on sign-up" copy="Risk identification is part of the full methodology. Create an account to see risks flagged against your selected financing label." />
              <BlockCard title="Top Recommendations — available on sign-up" copy="Prioritised actions map each failing criterion to the remediation needed to close the gap. Sign up to see the full list." />
            </div>
          ) : (
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
              <Card>
          ...
          {/* Label Criteria Breakdown — per-label pass/fail grid driven by evaluateLabel(). Renders for the 6 covered labels; otherwise falls through to the generic DNSH card below. Blocked in demo mode to protect methodology IP. */}
          {isDemo && currentAssessment.labelEvaluation && (
            <BlockCard title="Label Criteria Breakdown — available on sign-up" copy="The full criteria breakdown shows every qualifying criterion for your selected financing label with per-criterion status, detail, and regulatory citation. Sign up to see the complete breakdown." />
          )}
          {!isDemo && currentAssessment.labelEvaluation && (() => {
          ...
          {!isDemo && currentAssessment.dnsh?.details && (() => {
            const le = currentAssessment.labelEvaluation;
          ...
          {/* AI Narrative Panel — suppressed in demo mode to avoid exposing full regulatory analysis. */}
          {!isDemo && (aiLoading || aiNarrative) && (
            <Card style={{ marginTop: 24, background: COLORS.accentSubtle, borderColor: `${COLORS.accent}33` }}>
          ...
          {/* Regulatory Q&A — blocked in demo mode. */}
          {isDemo ? (
            <BlockCard title="Regulatory Q&A — available on sign-up" copy="Ask follow-up questions about your assessment and get regulator-cited answers grounded in your project's data. Sign up to enable the Q&A assistant." />
          ) : (
            <Card style={{ marginTop: 24 }}>
          ...
          {isDemo ? (
            <div style={{ display: "flex", gap: 12, marginTop: 24, flexWrap: "wrap" }}>
              <Button variant="secondary" icon="download" disabled title="Sign up to download the full assessment report">Download PDF</Button>
              <Button variant="secondary" icon="download" disabled title="Sign up to download the full assessment report">Download Excel</Button>
              <Button icon="advisory" disabled title="Sign up to request advisory support">Request Advisory Support</Button>
              <Button onClick={() => { setUser(null); setCurrentProject(null); setScreen("onboarding"); }}>Create Account to Unlock</Button>
            </div>
          ) : (
            <div style={{ display: "flex", gap: 12, marginTop: 24, flexWrap: "wrap" }}>
        ...
        <div style={{ animation: "fadeIn 0.4s ease-out" }}>
          ...
          <Card style={{ marginTop: 24, background: COLORS.accentSubtle, borderColor: `${COLORS.accent}33` }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <Button onClick={() => setNavItem("advisory")}>Talk to Perennity Bridge Advisory</Button>
            </div>
          </Card>
        </div>
      );
    ...
    if (navItem === "advisory") {
      return (
        <div style={{ animation: "fadeIn 0.4s ease-out", maxWidth: 640 }}>
          ...
          <p style={{ color: COLORS.textSecondary, fontSize: 15, marginBottom: 32 }}>Connect with Perennity Bridge's advisory team for expert support on your project.</p>
          <Card>
            ...
            <div style={{ padding: "16px 20px", borderTop: `1px solid #1a3040` }}>
              ...
              {!user?.isDemo && (
                <div
                  ...
                  style={{ fontSize: 11, color: "rgba(255,255,255,0.55)", cursor: "pointer", padding: "4px 0", display: "flex", alignItems: "center", gap: 6 }}
                  onMouseEnter={e => e.currentTarget.style.color = "#4ECDA4"}
                  onMouseLeave={e => e.currentTarget.style.color = "rgba(255,255,255,0.55)"}
                >
              ...
              {user?.isDemo && (
                <div
                  onClick={() => { setUser(null); setCurrentProject(null); setScreen("landing"); }}
                  style={{ fontSize: 11, color: "#4ECDA4", cursor: "pointer", padding: "4px 0", fontWeight: 500 }}
                >
                  ← Exit demo
                </div>
              )}
